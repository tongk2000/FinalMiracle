...
<div style="border: 3px solid pink;">
	...
	<div style="border: 3px solid green; float: left;">
		<a href="<%=request.getContextPath()%>/doList.mr"><img
			src="<%=request.getContextPath()%>/resources/images/logo.png"
			height="100px;" width="250px;"></a>
	</div>
	...
	<c:if test="${sessionScope.loginUser != null}">
		...
		<div
			...
			<div class="user img"
				style="float: left; width: 30%; height: 85%; border: 2px solid red;">
				<img
					src="<%= request.getContextPath() %>/resources/images/${sessionScope.loginUser.img}"
					style="height: 100%; width: 100%;">&nbsp;&nbsp;
			</div>
			<div class="user id"
				style="float: right; width: 55%; border: 1px solid blue;">
			...
			<div class="user menu" style="float: right; border: 1px solid cyan;">
				<a href="<%=request.getContextPath()%>/member_edit.mr">[내정보
					수정]</a> &nbsp;&nbsp; <a
					href="<%=request.getContextPath()%>/member_logout.mr">[로그아웃]</a>
			</div>
		</div>
	</c:if>
</div>
