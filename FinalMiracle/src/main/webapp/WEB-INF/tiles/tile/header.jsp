...
<div style="/* border: 3px solid pink; */ width: 100%; height: 50px; background-color: #ffffff;">
	...
	<c:if test="${sessionScope.loginUser != null}">
		<div style="/* border: 3px solid yellow; */ float: left; width: 33%; height: 50px;" align="right">
			...
			<a href="javascript:showMyInfo();" title="${sessionScope.loginUser.name}(${sessionScope.loginUser.userid})"><img src="<%= request.getContextPath() %>/resources/images/${sessionScope.loginUser.img}" style="height: 50px; width: 50px; border-radius: 25px;"></a>
		</div>
	</c:if>
</div>
