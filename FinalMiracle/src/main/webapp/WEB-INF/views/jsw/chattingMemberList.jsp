...
<body>
	<div style="font-size: 20px; text-align: left;">
		<div style="border-bottom: 1px solid white; text-align: center; height: 30px;">대화상대</div>
			<div onclick="addPersonStart()" style="cursor: pointer; color: #6600ff; margin: 5px;"><span class="circle" style="vertical-align: middle; font-size: 50px;">&nbsp;+ </span>&nbsp;대화상대 초대</div>
			...
			<div onclick="outRoom()" style="cursor: pointer; text-align: center; margin-top: 10px; padding-top :13px; padding-bottom: 3px; border-top: 1px solid white;"><i class="glyphicon glyphicon-log-out"></i> 채팅방 나가기</div>
	</div>
