...
<script type="text/javascript">
   ...
   $(document).ready(function(){
	  ...
	  $("#hp2").blur(function(){
		   ...
		   if(hp2 != ""){
		   //  var pattern = new RegExp(/\d{3,4}/g);   
			   var pattern = /\d{3,4}/g;
			   // 숫자만 체크 정규식 최소3자리, 최대4자리
	   ...
	   $("#idcheck").click(function(){
			// 팝업창 띄우기
			window.open("member_idDuplicateCheck.mr", "idcheck",
...
<div class="content" align="center">
	<form name="registerFrm">
		...
		<thead>
			<tr>
				<th colspan="2" id="th">
					회원 가입 (<span style="font-size: 10pt; font-style: !important; color: blue;"><span class="star"> *</span> 항목 기입 필수 </span>)
				</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				...
				<td style="width: 80%; text-align: left;">
				    ...
				    <!-- 아이디중복체크 -->
				    <a class="btn btn-xs btn-warning" id="idcheck"><span style="color: #4F84C4;"><span class="glyphicon glyphicon-ok-circle"></span> ID검사</span></a> 
			...
			<tr>
				...
				<td style="width: 80%; text-align: left;">
					...
					<span class="error">암호는 영문자, 숫자, 특수기호가 혼합된 8~15글자로만 입력가능합니다.</span>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" style="text-align: center; vertical-align: middle;">
					<iframe src="<%= request.getContextPath() %>/resources/agree/agree.html" width="88%" height="150px;" class="box"></iframe><br/><br/>	
				</td>
			</tr>
			<tr>
				<td colspan="2" style="text-align: center; vertical-align: middle;">
					<a class="btn btn-sm btn-success" onClick="goRegister(event);"><span style="color: white; font-size: 14pt;"><span class="glyphicon glyphicon-check"></span>  회원가입   </span></a> &nbsp;&nbsp;
					<a class="btn btn-sm btn-success" href="<%= request.getContextPath() %>/member_login.mr"><span style="color: white; font-size: 14pt;"><span class="glyphicon glyphicon-remove"></span>  로그인화면으로   </span></a><br/><br/>	  
				</td>
